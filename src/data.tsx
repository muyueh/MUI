...
const avatarBase = 'https://mui.com/static/images/avatar';

export const users: UserProps[] = [
  {
    name: 'Steve E.',
    username: '@steveEberger',
    avatar: `${avatarBase}/2.jpg`,
    online: true,
  },
  {
    name: 'Katherine Moss',
    username: '@kathy',
    avatar: `${avatarBase}/3.jpg`,
    online: false,
  },
  {
    name: 'Phoenix Baker',
    username: '@phoenix',
    avatar: `${avatarBase}/1.jpg`,
    online: true,
  },
  {
    name: 'Eleanor Pena',
    username: '@eleanor',
    avatar: `${avatarBase}/4.jpg`,
    online: false,
  },
  {
    name: 'Kenny Peterson',
    username: '@kenny',
    avatar: `${avatarBase}/5.jpg`,
    online: true,
  },
  {
    name: 'Al Sanders',
    username: '@al',
    avatar: `${avatarBase}/6.jpg`,
    online: true,
  },
  {
    name: 'Melissa Van Der Berg',
    username: '@melissa',
    avatar: `${avatarBase}/7.jpg`,
    online: false,
  },
];
